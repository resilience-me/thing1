...
SERVER_AS_CLIENT_DIR = $(SERVER_SERVICES_DIR)/server_as_client
...
SERVER_AS_CLIENT_OBJ_DIR = $(SERVER_SERVICES_OBJ_DIR)/server_as_client
...
SERVER_AS_CLIENT_SOURCES = $(wildcard $(SERVER_AS_CLIENT_DIR)/*.c)
SERVER_AS_CLIENT_OBJECTS = $(patsubst $(SERVER_AS_CLIENT_DIR)/%.c,$(SERVER_AS_CLIENT_OBJ_DIR)/%.o,$(SERVER_AS_CLIENT_SOURCES))
...
create_dirs:
	mkdir -p $(COMMON_OBJ_DIR) $(CLIENT_OBJ_DIR) $(BIN_DIR) $(SERVER_OBJ_DIR) $(CLIENT_SERVICES_OBJ_DIR) $(SERVER_SERVICES_OBJ_DIR) $(SERVER_AS_SERVER_OBJ_DIR) $(SERVER_AS_CLIENT_OBJ_DIR)
...
$(SERVER_EXEC): $(COMMON_OBJECTS) $(SERVER_OBJECTS) $(SERVER_SERVICES_OBJECTS) $(CLIENT_SERVICES_OBJECTS) $(SERVER_AS_SERVER_OBJECTS) $(SERVER_AS_CLIENT_OBJECTS)
...
$(SERVER_AS_CLIENT_OBJ_DIR)/%.o: $(SERVER_AS_CLIENT_DIR)/%.c
	$(CC) -c $(CFLAGS) $< -o $@
