...
This implementation will then use no encryption of the messages. It will use no encryption since encryption isn't strictly needed to run Ripple. And, assuming account-to-account encryption, the account identifier has to be plaintext anyway. It is easy to add.
